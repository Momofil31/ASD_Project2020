...
int main() {
    ...
    cout << "FUNZIONA SOLO SU INPUT 20" << endl;
    TARGET_THRESHOLD = 1500; //TODO
...
/****************************  CODICE DFS DENSA E CASA ANTICIPATA ****************************/
...
void computeSolutionDense() {
    ...
    for (int i = 0; i < W_WHITE; ++i) {
        ...
        if (colW <= colMin && rowW >= rowMax && isIsolatedCell(rowW, colW)) {
            colMin = colW;
            rowMax = rowW;
            START_ROW = rowW;
            START_COL = colW;
